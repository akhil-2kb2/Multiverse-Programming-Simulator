...
int main()
{
    ...
    while (1)
    {
        if (missions >= maxMissions)
        {
            ...
            printf("============================================================\n");
            printf("You have completed %d missions.\n", missions);

            printf("\nDo you want to extend your mission limit?\n");
            printf("1. Yes\n");
            ...
            if (extendChoice == 1)
            {
                printf("How many additional missions do you want to unlock? ");
            ...
            {
                printf("\nTimeline Closed by User Decision.\n");
                break;
            }
        }
